...
export const rootB = [
    {
        ...
        김첨지는 술집에 들어가고 싶은 마음이 굴뚝같았지만 설렁탕을 사서 집으로 가기로 결정했다.
        
        김첨지는 자신을 덮쳐오는 불안을 회피하는 것이 아닌 마주하기로 결정했다.
        
        설렁탕을 사서 집으로 가려는길 인자하게 생긴 중년 남성이 김첨지를 불러세웠다.
        
        “남대문 사거리까지 가시나?”
        
        우연히 김첨지의 집과 방향이 같아 김첨지는 태워주기로 했다.
        
        
        조급한 마음에 김첨지의 발걸음이 빨라지자 손님이 물었다.
        
        “무슨 급한일이 있는가?”
        
        “마누라가 아파서 일찍 들어가보려합니다”
        
        “저런 , 무슨병인가?”
        
        “돈이 없어 아직 의사한테 보여주지 못했습니다요”
        
        “그렇군 , 내가 사실 왕진 의사라네 자네만 괜찮다면 내가 한번 봐주겠네”
        
        김첨지는 깜짝 놀라 뒤를 돌아보니 손님은 왕진 가방을 가지고 다니는 의사였다.
        
        “감사합니다요 의사 나으리! 요금은 안받겠습니다”
        
        김첨지는 희망을 만난듯 발걸음이 더욱 빨라졌다.
        `
    },
    {
        page: 14, type: "text", text: `김첨지와 의사는 집에 다달았다.  
        김 첨지가 한 발을 대문에 들여놓았을 미미한 숨소리만이 있었다.
        
        김 첨지는 방문을 왈칵 열었다. 구역을 나게 하는 추기 — 떨어진 삿자리 밑에서 나온 먼지내, 빨지 않은 기저귀에서 나는 똥내와 오줌내, 가지각색 때가 케케히 앉은 옷내, 병인의 땀 썩은 내가 섞인 추기가 무딘 김 첨지의 코를 찔렀다.
        
        의사 선생은 개의치 않고 환자의 진료를 시작했다.
        진료를 하며 죽음같은 침묵이 흘렀다.
        김첨지는 그저 바라만 볼 뿐이였다.
        
        이윽고 진료가 끝났는지 의사선생은 김 첨지를 바라보며 말했다.
        
        “ 폐렴이군 , 예전 같았으면 죽을 병이지만 설파제라는 항생제가 나온 지금이라면 완치 가능한 병이네”
        
        의사 선생은 진료 가방에서 주섬 주섬 하얀 가루를 꺼내더니 환자의 입에 털어 넣기 시작했다.
        설파제를 투여한지 수초 뒤 부인은 기침을 하며 발작을 하기 시작했다.
        
        “의사 나으리! 무슨 일입니까?”
        
        김첨지는 불안한 마음에 의사를 불렀다
        
        “괜찮네! 폐에 있는 페렴균들이 항생제에 저항을 하고있는걸세 “
        
        그렇게 수분동안 기침 발작을 한 후 잠잠해 졌다.
        그걸 지켜본 의사는 짐을 챙기며 나갈채비를 하였다
        
        “내일 아침쯤이면 일어날 걸세.
        주기적으로 오며 나을떄까지 진료 해주겠네”
        `
    },
    {
        page: 15, type: "text", text: `김첨지는 나가는 의사에게 가진 돈을 내밀었다. 50전 남짓이였다.

        “됐네 , 마음만 받겠네”
        
        “나으리 감사합니다. . 정말 감사합니다.”
        
        김 첨지는 감사한 마음에 큰절을 올렸다.
        
        “목숨이 중요하지 그깟 돈이 중요하겠나 그럼 또 오겠네”
        
        의사가 나갈때까지 김첨지는 감사한 마음에 고개를 들지 못했다.
        `
    },
    {
        page: 16, type: "text", text: `다음날 아침, 부인이 일어나고 김첨지는 아침으로 어제사온 설렁탕을 부인에게 데워주었다.
        부인은 어제보다 훨씬 좋아진 안색으로 허겁지겁 설렁탕을 먹었다.
        
        “고마워요 , 설렁탕이 맛있네요”
        
        “오지랄년 , 잘도 쳐먹네 오지랄년 ….”  
        
        김첨지는 웃는건지 우는건지 알수없는 표정이 되어 부인이 먹는 모습을 하염없이 지켜보았다.
        `
    },
...
export const prologue = [
    ...
    // { type: "three", model: '18569_Human-Pulled Rickshaw_v1.obj, Defeated.fbx' },
    {
...
// export var story = [...diversity.prologue];




export const [useStoryStore, storyAPI] = create(set => ({
...
export const [useStore] = create(set => ({
    ...
    origin: prologue,
    root: "main",
    rootChange: (datRoot) => set({ root: datRoot }),
    set: (fn) => set(produce(fn))
}))
...
// main 에서 [ ...a 이런식으로 합쳐주자 ... ]
// 뒤에다가 실시간으로 붙게할건지 ... 
// 아니면 아예 새로운 페이지로 할건지가 ...
// 위에 것이 낫겠군 ... 
