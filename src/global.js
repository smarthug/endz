...
export const data = {
    pages: [{
        page: 0, type:"img" , img:"https://cpb-us-w2.wpmucdn.com/blogs.baylor.edu/dist/c/3127/files/2015/12/DQ-Screen-Shot-2015-12-04-at-4.10.29-PM-29wbxtz.png", options:{choices:[{text:"hello", result:{text:"It went good"}}  ]} , text: `In a village of La Mancha, the name of which I have no desire to call
